...
public partial class CosmeticsDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Cosmetic__19093A2BEC5DA56B");
        ...
        {
            entity.HasKey(e => e.CosmeticId).HasName("PK__Cosmetic__98ED527EC5E6E177");
        ...
        {
            entity.HasKey(e => e.AccountId).HasName("PK__SystemAc__349DA586EBB6141C");

            entity.ToTable("SystemAccount");

            entity.HasIndex(e => e.EmailAddress, "UQ__SystemAc__49A147401CCBFBE4").IsUnique();
